...
elemental_obi_weaponskills = S{'Wildfire','Leaden Salute','Sanguine Blade','Aeolian Edge','Cataclysm'}
...
no_skill_spells_list = S{'Raise', 'Reraise', 'Arise','Full Cure','Tractor'}

		--preserving original but removing many so that they will use enhancing magic for duration instead of fastrecast
