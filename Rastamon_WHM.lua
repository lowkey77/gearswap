...
function init_gear_sets()
    ...
    sets.precast.Waltz = {
        ...
        back="Refraction Cape",legs="Portent Pants",feet="Gendewitha Galoshes"}
    ...
    sets.precast.WS = {
        ...
        back="Refraction Cape",waist=gear.ElementalBelt,legs="Portent Pants",feet="Gendewitha Galoshes"}
    
    sets.precast.WS['Flash Nova'] = {
        head="Nahtirah Hat",neck="Stoicheion Medal",ear1="Friomisi Earring",ear2="Hecate's Earring",
        body="Vanir Cotehardie",hands="Yaoyotl Gloves",ring1="Rajas Ring",ring2="Strendu Ring",
        back="Toro Cape",waist="Thunder Belt",legs="Portent Pants",feet="Gendewitha Galoshes"}
    ...
    sets.midcast.FastRecast = {
        ...
        body="Helios Jacket",hands="Telchine Gloves",ring1="Veneficium Ring",ring2="Prolix Ring",
        back="Swith Cape +1",waist="Goading Belt",legs="Gyve Trousers",feet="Hagondes Sabots"}
    ...
    sets.midcast.CureSolace = {main="Tamaxchi",sub="Genbu's Shield",ammo="Incantor Stone",
        head="Vanya Hood",neck="Orison Locket",ear1="Nourishing Earring",ear2="Loquacious Earring",
        body="Piety Briault +1 +1",hands="Bokwus Gloves",ring1="Veneficium Ring",ring2="Prilix Ring",
        back="Swith Cape +1",waist=gear.ElementalObi,legs="Orison Pantaloons +2",feet="Theophany Duckbills"}
    ...
    sets.midcast['Enhancing Magic'] = {main="Beneficus",sub="Genbu's Shield",
        ...
        back="Mending Cape",waist="Siuegel Sash",legs="Orison Pantaloons +2",feet="Orison Duckbills +1"}

    sets.midcast.Stoneskin = {
        head="Nahtirah Hat",neck="Orison Locket",ear2="Loquacious Earring",
        body="Vanir Cotehardie",hands="Dynasty Mitts",
        back="Swith Cape +1",waist="Siegel Sash",legs="Portent Pants",feet="Gendewitha Galoshes"}

    sets.midcast.Auspice = {hands="Dynasty Mitts",feet="Orison Duckbills +1"}
    ...
    sets.midcast.Regen = {main="Tamaxchi",sub="Genbu's Shield",
        body="Piety Briault +1",hands="Orison Mitts +2",
        legs="Theophany Pantaloons"}

    sets.midcast.Protectra = {ring1="Sheltered Ring",feet="Theophany Duckbills"}

    sets.midcast.Shellra = {ring1="Sheltered Ring",legs="Orison Pantaloons +2"}


    sets.midcast['Divine Magic'] = {main="Tamaxchi",sub="Genbu's Shield",
    ...
    sets.midcast['Dark Magic'] = {main="Tamaxchi", sub="Genbu's Shield",
        head="Nahtirah Hat",neck="Aesir Torque",ear1="Psystorm Earring",ear2="Lifestorm Earring",
        body="Vanir Cotehardie",hands="Yaoyotl Gloves",ring1="Strendu Ring",ring2="Sangoma Ring",
        back="Refraction Cape",waist="Demonry Sash",legs="Bokwus Slops",feet="Theophany Duckbills"}
    ...
    sets.idle = {main="Tamaxchi", sub="Genbu's Shield",ammo="Homiliary",
        head="Befouled Crown",neck="Wiglen Gorget",ear1="Nourishing Earring",ear2="Loquacious Earring",
    ...
    sets.idle.PDT = {main="Tamaxchi", sub="Genbu's Shield",ammo="Homiliary",
        head="Befouled Crown",neck="Twilight Torque",ear1="Bloodgem Earring",ear2="Loquacious Earring",
        body="Gendewitha Bliaut",hands="Gendewitha Gages",ring1="Defending Ring",ring2=gear.DarkRing.physical,
        back="Umbra Cape",waist="Witful Belt",legs="Portent Pants",feet="Herald's Gaiters"}

    sets.idle.Town = {main="Tamaxchi", sub="Genbu's Shield",ammo="Homiliary",
        head="Befouled Crown",neck="Wiglen Gorget",ear1="Bloodgem Earring",ear2="Loquacious Earring",
        body="Piety Briault +1",hands="Gendewitha Gages",ring1="Sheltered Ring",ring2="Paguroidea Ring",
        back="Umbra Cape",waist="Witful Belt",legs="Nares Trews",feet="Herald's Gaiters"}
    
    sets.idle.Weak = {main="Tamaxchi",sub="Genbu's Shield",ammo="Homiliary",
        head="Befouled Crown",neck="Twilight Torque",ear1="Bloodgem Earring",ear2="Loquacious Earring",
    ...
    sets.defense.PDT = {main=gear.Staff.PDT,sub="Achaq Grip",
        ...
        body="Gendewitha Bliaut",hands="Gendewitha Gages",ring1="Defending Ring",ring2=gear.DarkRing.physical,
        back="Umbra Cape",legs="Portent Pants",feet="Gendewitha Galoshes"}

    sets.defense.MDT = {main=gear.Staff.PDT,sub="Achaq Grip",
        head="Nahtirah Hat",neck="Twilight Torque",
        body="Vanir Cotehardie",hands="Yaoyotl Gloves",ring1="Defending Ring",ring2="Shadow Ring",
        back="Swith Cape +1",legs="Bokwus Slops",feet="Gendewitha Galoshes"}
    ...
    sets.engaged = {
        ...
        back="Umbra Cape",waist="Goading Belt",legs="Portent Pants",feet="Gendewitha Galoshes"}
