...
function init_gear_sets()
    ...
    sets.precast.WS.Acc = set_combine(sets.precast.WS, {neck="Combatant's Torque",ear1="Telos Earring",body="Meg. Cuirie +1",hands="Meg. Gloves +1",ring2="Ramuh Ring +1",waist="Olseni Belt",legs="Meg. Chausses +1",feet=gear.herculean_acc_feet})
	sets.precast.WS.FullAcc = set_combine(sets.precast.WS, {neck="Combatant's Torque",ear1="Telos Earring",body="Meg. Cuirie +1",hands="Meg. Gloves +1",ring1="Ramuh Ring +1",ring2="Ramuh Ring +1",waist="Olseni Belt",legs="Meg. Chausses +1",feet=gear.herculean_acc_feet})

    -- Specific weaponskill sets.  Uses the base set if an appropriate WSMod version isn't found.
    sets.precast.WS["Rudra's Storm"] = set_combine(sets.precast.WS, {head="Lilitu Headpiece",neck="Caro Necklace",ear1="Moonshade Earring",ear2="Ishvara Earring",body="Adhemar Jacket",hands="Meg. Gloves +1",ring1="Ilabrat Ring",ring2="Ramuh Ring +1",back=gear.ws_jse_back})
    sets.precast.WS["Rudra's Storm"].SomeAcc = set_combine(sets.precast.WS.SomeAcc, {head="Lilitu Headpiece",neck="Caro Necklace",ear1="Moonshade Earring",body="Meg. Cuirie +1",hands="Meg. Gloves +1",ring1="Ilabrat Ring",ring2="Ramuh Ring +1",back=gear.ws_jse_back})
    sets.precast.WS["Rudra's Storm"].Acc = set_combine(sets.precast.WS.Acc, {ear1="Moonshade Earring",body="Meg. Cuirie +1",hands="Meg. Gloves +1",ring2="Ramuh Ring +1",back=gear.ws_jse_back})
    ...
    sets.precast.WS["Mandalic Stab"] = set_combine(sets.precast.WS, {head="Lilitu Headpiece",neck="Caro Necklace",ear1="Moonshade Earring",ear2="Ishvara Earring",body="Meg. Cuirie +1",hands="Meg. Gloves +1",ring1="Karieyh Ring",ring2="Ramuh Ring +1",back=gear.ws_jse_back})
    sets.precast.WS["Mandalic Stab"].SomeAcc = set_combine(sets.precast.WS.SomeAcc, {head="Lilitu Headpiece",neck="Caro Necklace",ear1="Moonshade Earring",body="Meg. Cuirie +1",hands="Meg. Gloves +1",ring1="Karieyh Ring",ring2="Ramuh Ring +1",back=gear.ws_jse_back})
    sets.precast.WS["Mandalic Stab"].Acc = set_combine(sets.precast.WS.Acc, {ear1="Moonshade Earring",body="Meg. Cuirie +1",hands="Meg. Gloves +1",ring1="Karieyh Ring",ring2="Ramuh Ring +1",back=gear.ws_jse_back})
    ...
    sets.precast.WS["Shark Bite"] = set_combine(sets.precast.WS, {head="Lilitu Headpiece",neck="Caro Necklace",ear1="Moonshade Earring",ear2="Ishvara Earring",body="Meg. Cuirie +1",hands="Meg. Gloves +1",ring1="Karieyh Ring",ring2="Apate Ring",back=gear.ws_jse_back})
    sets.precast.WS["Shark Bite"].SomeAcc = set_combine(sets.precast.WS.SomeAcc, {head="Lilitu Headpiece",neck="Caro Necklace",ear1="Moonshade Earring",body="Meg. Cuirie +1",hands="Meg. Gloves +1",ring1="Karieyh Ring",ring2="Apate Ring",back=gear.ws_jse_back})
    sets.precast.WS["Shark Bite"].Acc = set_combine(sets.precast.WS.Acc, {ear1="Moonshade Earring",body="Meg. Cuirie +1",hands="Meg. Gloves +1",ring1="Karieyh Ring",ring2="Apate Ring",back=gear.ws_jse_back})
    ...
    sets.precast.WS['Evisceration'] = set_combine(sets.precast.WS, {ammo="Qirmiz Tathlum",head="Adhemar Bonnet",neck="Fotia Gorget",body="Abnoba Kaftan",hands="Mummu Wrists +2",ring1="Begrudging Ring",waist="Fotia Belt",legs="Darraigner's Brais",feet="Mummu Gamash. +1"})
    ...
    sets.precast.WS['Evisceration'].Acc = set_combine(sets.precast.WS.Acc, {head="Mummu Bonnet +1",ring1="Begrudging Ring",neck="Fotia Gorget",body="Mummu Jacket +1",hands="Mummu Wrists +2",waist="Fotia Belt",legs="Mummu Kecks +1",feet="Mummu Gamash. +1"})
    ...
    sets.precast.WS['Aeolian Edge'] = {ammo="Seeth. Bomblet +1",
        ...
        back=gear.ws_jse_back,waist="Chaac Belt",legs=gear.herculean_wsd_legs,feet=gear.herculean_wsd_feet}
    ...
    sets.idle = {ammo="Staunch Tathlum",
        ...
        body="Meg. Cuirie +1",hands=gear.herculean_dt_hands,ring1="Defending Ring",ring2="Sheltered Ring",
	...
	sets.engaged.Acc = {ammo="Seeth. Bomblet +1",
        ...
        body="Mummu Jacket +1",hands="Floral Gauntlets",ring1="Ilabrat Ring",ring2="Epona's Ring",
