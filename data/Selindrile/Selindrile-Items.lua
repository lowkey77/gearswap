...
gear.herculean_wsd_body = {name="Herculean Vest",augments={}}
...
gear.herculean_wsd_legs = {name="Herculean Trousers",augments={'Accuracy+24','Weapon skill damage +4%','Attack+9',}}
...
gear.hercluean_nuke_feet = { name="Herculean Boots", augments={'"Mag.Atk.Bns."+23','Rng.Acc.+14','Phalanx +1','Mag. Acc.+15 "Mag.Atk.Bns."+15',}}

gear.merlinic_nuke_head = {name="Merlinic Hood",augments={'Mag. Acc.+21 "Mag.Atk.Bns."+21','INT+15','Mag. Acc.+3','"Mag.Atk.Bns."+13',}}
gear.merlinic_magpact_head = {name="Merlinic Hood",augments={'Pet: "Mag.Atk.Bns."+9','Blood Pact Dmg.+10','Pet: INT+5','Pet: Mag. Acc.+6',}}
