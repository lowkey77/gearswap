...
function job_setup()
    ...
    state.ExtraSongsMode = M{['description']='Extra Songs', 'None', 'Dummy', 'Full Length'}
	...
	init_job_states({"Capacity","AutoTrustMode","AutoNukeMode","AutoWSMode","AutoFoodMode","AutoStunMode","AutoDefenseMode"},{"OffenseMode","WeaponskillMode","IdleMode","ExtraSongsMode","CastingMode","TreasureMode",})
end
...
function job_post_midcast(spell, spellMap, eventArgs)
    if spell.type == 'BardSong' then
		if state.ExtraSongsMode.value == 'Full Length' then
