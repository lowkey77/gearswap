...
function init_gear_sets()
    ...
    sets.precast.Waltz = {ammo="Sonia's Plectrum",
        head="Rao Kabuto",
        body="Dagon Breastplate",hands="Wakido Kote +2",ring1="Spiral Ring",
	...
	sets.precast.WS['Tachi: Kaiten'] = set_combine(sets.precast.WS, {left_ear="Ishvara Earring"})
    sets.precast.WS['Tachi: Kaiten'].Acc = set_combine(sets.precast.WS.Acc, {})
    sets.precast.WS['Tachi: Kaiten'].Mod = set_combine(sets.precast.WS['Tachi: Kaiten'], {})
    ...
    sets.precast.WS['Tachi: Rana'].Acc = set_combine(sets.precast.WS.Acc, {ear1="Telos Earring",ear2="Cessance Earring",})
    ...
    sets.midcast.FastRecast = {
        head="Rao Kabuto",
        body="Dagon Breastplate",hands="Wakido Kote +1",
