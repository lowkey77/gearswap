...
function user_setup()
        ...
        sam_sj = player.sub_job == 'SAM' or false
      	...
      	DefaultAmmo = {[gear.Bow] = "Achiyalabopa arrow", [gear.Gun] = "Quelling Bolt"}
	    U_Shot_Ammo = {[gear.Bow] = "Achiyalabopa arrow", [gear.Gun] = "Quelling Bolt"} 
...
function init_gear_sets()
        ...
        sets.precast.JA['Double Shot'] = {head="Oshosi mask"}
        ...
        sets.precast.FC = {head={ name="Herculean Helm", augments={'Attack+23','"Triple Atk."+3','STR+4','Accuracy+6',}},
    body="Foppish Tunica",
    ...
    back={ name="Belenus's Cape", augments={'DEX+20','Rng.Acc.+20 Rng.Atk.+20','DEX+1','"Snapshot"+10',}},}
        sets.precast.FC.Utsusemi = set_combine(sets.precast.FC, { neck="Magoraga Beads" })
        
        sets.idle = {head="Orion Beret +3",
    body="Orion Jerkin +3",
    ...
    back={ name="Lutian Cape", augments={'STR+4','AGI+3','"Store TP"+3','"Snapshot"+2',}},
        }
        ...
        sets.idle.Town = set_combine(sets.idle, {head="Orion Beret +3",
    body="Orion Jerkin +3",
    hands="Orion Bracers +3",
    legs="Amini Brague +1",
    feet={ name="Adhe. Gamashes +1", augments={'HP+65','"Store TP"+7','"Snapshot"+10',}},
    ...
    back={ name="Lutian Cape", augments={'STR+4','AGI+3','"Store TP"+3','"Snapshot"+2',}},
        ...
        -- Engaged sets
        sets.engaged =  {head={ name="Adhemar Bonnet +1", augments={'STR+12','DEX+12','Attack+20',}},
    ...
    back="Bleating Mantle",
        ...
        sets.engaged.Melee = {head={ name="Adhemar Bonnet +1", augments={'STR+12','DEX+12','Attack+20',}},
    body={ name="Adhemar Jacket +1", augments={'STR+12','DEX+12','Attack+20',}},
    hands={ name="Adhemar Wrist. +1", augments={'STR+12','DEX+12','Attack+20',}},
    legs={ name="Samnuha Tights", augments={'STR+10','DEX+10','"Dbl.Atk."+3','"Triple Atk."+3',}},
    feet={ name="Adhe. Gamashes +1", augments={'HP+65','"Store TP"+7','"Snapshot"+10',}},
    ...
    back="Bleating Mantle",
        ...
        ------------------------------------------------------------------
        sets.precast.RA = {head="Amini Gapette +1",
    body="Oshosi Vest",
    ...
    back={ name="Belenus's Cape", augments={'DEX+20','Rng.Acc.+20 Rng.Atk.+20','DEX+1','"Snapshot"+10',}},}
        ...
        sets.midcast.RA.Acc = set_combine(sets.midcast.RA.Mid, {head="Orion Beret +3",
    body="Orion Jerkin +3",
    hands="Orion Bracers +3",
    legs="Orion Braccae +3",
    feet="Orion socks +3",
    ...
    back={ name="Belenus's Cape", augments={'DEX+20','Rng.Acc.+20 Rng.Atk.+20','DEX+1','"Snapshot"+10',}},
        ...
        -- Bow base set.
        sets.midcast.RA.Bow = {head={ name="Arcadian Beret +3", augments={'Enhances "Recycle" effect',}},
    body="Orion Jerkin +3",
    hands={ name="Carmine Fin. Ga. +1", augments={'Rng.Atk.+20','"Mag.Atk.Bns."+12','"Store TP"+6',}},
    legs="Amini Brague +1",
    feet={ name="Adhe. Gamashes +1", augments={'HP+65','"Store TP"+7','"Snapshot"+10',}},
    ...
    back={ name="Lutian Cape", augments={'STR+4','AGI+3','"Store TP"+3','"Snapshot"+2',}},}
        ...
        sets.midcast.RA.Bow.Acc = set_combine(sets.midcast.RA.Bow.Mid, {head="Orion Beret +3",
    body="Orion Jerkin +3",
    hands="Orion Bracers +3",
    legs="Orion Braccae +3",
    feet="Meg. Jam. +2",
    ...
    back={ name="Belenus's Cape", augments={'DEX+20','Rng.Acc.+20 Rng.Atk.+20','DEX+1','"Snapshot"+10',}},
        ...
        -- Weaponskill sets  
        sets.precast.WS = {head="Orion Beret +3",
    body="Orion Jerkin +3",
    hands="Meg. Gloves +1",
    legs="Meg. Chausses +1",
    feet={ name="Adhe. Gamashes +1", augments={'HP+65','"Store TP"+7','"Snapshot"+10',}},
    ...
    back={ name="Belenus's Cape", augments={'DEX+20','Rng.Acc.+20 Rng.Atk.+20','DEX+1','"Snapshot"+10',}},}
        ...
        -- WILDFIRE
        sets.Wildfire = {head="Orion Beret +3",
    body="Orion Jerkin +3",
    hands="Meg. Gloves +1",
    legs="Meg. Chausses +1",
    feet={ name="Adhe. Gamashes +1", augments={'HP+65','"Store TP"+7','"Snapshot"+10',}},
    ...
    back={ name="Belenus's Cape", augments={'DEX+20','Rng.Acc.+20 Rng.Atk.+20','DEX+1','"Snapshot"+10',}},}
        ...
        sets.Trueflight = {head="Orion Beret +3",
    body={ name="Carm. Sc. Mail +1", augments={'Attack+20','"Mag.Atk.Bns."+12','"Dbl.Atk."+4',}},
    hands={ name="Carmine Fin. Ga. +1", augments={'Rng.Atk.+20','"Mag.Atk.Bns."+12','"Store TP"+6',}},
    legs={ name="Herculean Trousers", augments={'Mag. Acc.+17 "Mag.Atk.Bns."+17','"Fast Cast"+4','STR+15','Mag. Acc.+12','"Mag.Atk.Bns."+14',}},
    feet={ name="Herculean Boots", augments={'Mag. Acc.+7 "Mag.Atk.Bns."+7','Weapon skill damage +4%','MND+2','"Mag.Atk.Bns."+13',}},
    neck="Baetyl Pendant",
    waist="Eschan Stone",
    left_ear="Friomisi Earring",
    ...
    back={ name="Belenus's Cape", augments={'AGI+20','Mag. Acc+20 /Mag. Dmg.+20','AGI+10','Weapon skill damage +10%',}},}
        ...
        -- LAST STAND
        sets.LastStand = {head="Orion Beret +3",
    body="Orion Jerkin +3",
    hands="Meg. Gloves +2",
    legs={ name="Herculean Trousers", augments={'Attack+29','Weapon skill damage +4%','STR+2','Accuracy+2',}},
    feet={ name="Herculean Boots", augments={'Mag. Acc.+7 "Mag.Atk.Bns."+7','Weapon skill damage +4%','MND+2','"Mag.Atk.Bns."+13',}},
    neck="Fotia Gorget",
    waist="Fotia Belt",
    ...
    back={ name="Belenus's Cape", augments={'DEX+20','Rng.Acc.+20 Rng.Atk.+20','DEX+1','"Snapshot"+10',}},}
        ...
        sets.precast.WS['Last Stand'].SAM = set_combine(sets.precast.WS, {head="Orion Beret +3",
    body="Orion Jerkin +3",
    hands="Meg. Gloves +2",
    legs={ name="Herculean Trousers", augments={'Attack+29','Weapon skill damage +4%','STR+2','Accuracy+2',}},
    feet={ name="Herculean Boots", augments={'Mag. Acc.+7 "Mag.Atk.Bns."+7','Weapon skill damage +4%','MND+2','"Mag.Atk.Bns."+13',}},
    ...
    back={ name="Belenus's Cape", augments={'DEX+20','Rng.Acc.+20 Rng.Atk.+20','DEX+1','"Snapshot"+10',}}, 
		...
		-- HOTSHOT
		sets.HotShot = {head="Orion Beret +3",
    body={ name="Carm. Sc. Mail +1", augments={'Attack+20','"Mag.Atk.Bns."+12','"Dbl.Atk."+4',}},
    hands={ name="Carmine Fin. Ga. +1", augments={'Rng.Atk.+20','"Mag.Atk.Bns."+12','"Store TP"+6',}},
    legs={ name="Herculean Trousers", augments={'Mag. Acc.+17 "Mag.Atk.Bns."+17','"Fast Cast"+4','STR+15','Mag. Acc.+12','"Mag.Atk.Bns."+14',}},
    feet={ name="Herculean Boots", augments={'Mag. Acc.+7 "Mag.Atk.Bns."+7','Weapon skill damage +4%','MND+2','"Mag.Atk.Bns."+13',}},
    ...
    back={ name="Belenus's Cape", augments={'AGI+20','Mag. Acc+20 /Mag. Dmg.+20','AGI+10','Weapon skill damage +10%',}},}
        ...
        -- JISHNUS
        sets.Jishnus = {head={ name="Adhemar Bonnet +1", augments={'STR+12','DEX+12','Attack+20',}},
    body="Meg. Cuirie +1",
    hands={ name="Adhemar Wrist. +1", augments={'STR+12','DEX+12','Attack+20',}},
    legs={ name="Herculean Trousers", augments={'Attack+29','Weapon skill damage +4%','STR+2','Accuracy+2',}},
    feet="Thereoid Greaves",
    ...
    back={ name="Belenus's Cape", augments={'AGI+20','Mag. Acc+20 /Mag. Dmg.+20','AGI+10','Weapon skill damage +10%',}},}
        ...
        sets.buff.Barrage = {head="Orion Beret +3",
    body="Orion Jerkin +3",
    hands="Orion Bracers +3",
    legs="Meg. Chausses +1",
    feet={ name="Adhe. Gamashes +1", augments={'HP+65','"Store TP"+7','"Snapshot"+10',}},
...
function job_pretarget(spell, action, spellMap, eventArgs)
    ...
    if spell.action_type == 'Ranged Attack' then
        if player.tp >= 1250 and state.AutoRA.value == 'WS' and not buffactive.amnesia then
            cancel_spell()
            use_weaponskill()
        end
    end
