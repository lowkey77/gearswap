...
function job_setup()
	...
	init_job_states({"Capacity","AutoTrustMode","AutoNukeMode","AutoWSMode","AutoFoodMode","AutoStunMode","AutoDefenseMode",},{"OffenseMode","WeaponskillMode","IdleMode","RecoverMode","CastingMode","TreasureMode",})
end
...
function job_post_midcast(spell, spellMap, eventArgs)
    ...
    if spellMap == 'StatusRemoval' then
		...
		if spell.english == 'Cursna' and (player.sub_job == 'NIN' or player.sub_job == 'DNC') and sets.midcast.DWCursna then
