...
function init_gear_sets()
	...
	sets.precast.FC = {
		...
		sub="Enki Strap",
		ammo="Regal Gem",
		head={ name="Chironic Hat", augments={'"Mag.Atk.Bns."+10','"Fast Cast"+6','Mag. Acc.+2',}},
		body="Shango Robe",
		hands={ name="Chironic Gloves", augments={'Mag. Acc.+15','"Cure" spellcasting time -10%','CHR+4',}},
	...
	sets.midcast['Enhancing Magic'] = {
		...
		ammo="Regal Gem",
		head="Befouled Crown",
		body={ name="Telchine Chas.", augments={'Enh. Mag. eff. dur. +1',}},
		hands={ name="Chironic Gloves", augments={'Mag. Acc.+15','"Cure" spellcasting time -10%','CHR+4',}},
	...
	sets.midcast['Bio III'] = set_combine(sets.midcast['Enfeebling Magic'], {waist="Chaac Belt",legs="Vitivation Tights +3",feet=gear.chironic_treasure_feet})
	...
	sets.midcast['Blind II'] = set_combine(sets.midcast['Enfeebling Magic'], {head="Vitiation Chapeau +3",legs="Vitivation Tights +3"})
	...
	sets.idle = {
		...
		hands={ name="Chironic Gloves", augments={'Mag. Acc.+15','"Cure" spellcasting time -10%','CHR+4',}},
		legs="Nares Trews",
		feet={ name="Chironic Slippers", augments={'Attack+10','Accuracy+21','Phalanx +5','Accuracy+9 Attack+9','Mag. Acc.+20 "Mag.Atk.Bns."+20',}},
