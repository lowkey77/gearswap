...
function init_gear_sets()
	...
	sets.precast.JA.Jump = {ammo="Hagneia Stone",
		head="Flamma Zucchetto +2",neck="Ganesha's Mala",ear1="Brutal Earring",ear2="Tripuido Earring",
	...
	sets.precast.WS.SomeAcc = set_combine(sets.precast.WS, {ammo="Knobkierrie",body="Dagon Breastplate"})
	sets.precast.WS.Acc = set_combine(sets.precast.WS, {ammo="Knobkierrie",body="Dagon Breastplate",hands="Xaddi Gauntlets"})
