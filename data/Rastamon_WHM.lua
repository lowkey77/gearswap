...
function init_gear_sets()
    ...
    sets.midcast.CureSolace = {main="Tamaxchi",sub="Genbu's Shield",ammo="Incantor Stone",
        head="Vanya Hood",neck="Orison Locket",ear1="Nourish. Earring +1",ear2="Loquacious Earring",
    ...
    sets.idle = {main="Tamaxchi", sub="Genbu's Shield",ammo="Homiliary",
        head="Befouled Crown",neck="Wiglen Gorget",ear1="Nourish. Earring +1",ear2="Loquacious Earring",
