...
sets.precast.Death={
    main={ name="Grioavolr", augments={'"Fast Cast"+2','Mag. Acc.+30','"Mag.Atk.Bns."+29','Magic Damage +5',}},
    sub="Clerisy Strap",
    ammo="Impatiens",
    head="Kaabnax Hat",
    ...
    sets.precast.FC = {main={ name="Grioavolr", augments={'"Fast Cast"+2','Mag. Acc.+30','"Mag.Atk.Bns."+29','Magic Damage +5',}},
    ...
    sets.midcast.FastRecast = {
        ...
        body="Helios Jacket",hands={ name="Merlinic Dastanas", augments={'Mag. Acc.+22 "Mag.Atk.Bns."+22','Magic Damage +14','Mag. Acc.+2','"Mag.Atk.Bns."+9',}},
		ring1="Prolix Ring",
    ...
    sets.midcast['Enfeebling Magic'] = {main={ name="Grioavolr", augments={'"Fast Cast"+2','Mag. Acc.+30','"Mag.Atk.Bns."+29','Magic Damage +5',}},
		sub="Clerisy Strap",ammo="Floestone",
    ...
    sets.midcast['Dark Magic'] = {main={ name="Grioavolr", augments={'"Fast Cast"+2','Mag. Acc.+30','"Mag.Atk.Bns."+29','Magic Damage +5',}},
		sub="Clerisy Strap",ammo="Floestone",
    ...
    sets.midcast.Drain = {main={ name="Grioavolr", augments={'"Fast Cast"+2','Mag. Acc.+30','"Mag.Atk.Bns."+29','Magic Damage +5',}},
    ...
    sets.midcast.Stun = {main={ name="Grioavolr", augments={'"Fast Cast"+2','Mag. Acc.+30','"Mag.Atk.Bns."+29','Magic Damage +5',}},
		sub="Clerisy Strap",ammo="Floestone",
    ...
    sets.midcast.BardSong = {main={ name="Grioavolr", augments={'"Fast Cast"+2','Mag. Acc.+30','"Mag.Atk.Bns."+29','Magic Damage +5',}},
		sub="Clerisy Strap",ammo="Sturm's Report",
        head="Nahtirah Hat",neck="Weike Torque",ear1="Psystorm Earring",ear2="Lifestorm Earring",
    ...
    sets.midcast['Elemental Magic'] = {main={ name="Grioavolr", augments={'"Fast Cast"+2','Mag. Acc.+30','"Mag.Atk.Bns."+29','Magic Damage +5',}},
		sub="Clerisy Strap",ammo="Witchstone",
        head="Wicce Petasos",neck="Mizukage-no-Kubikazari",ear1="Barkarole Earring",ear2="Halasz Earring",
        body="Spae. Coat +1",hands={ name="Merlinic Dastanas", augments={'Mag. Acc.+22 "Mag.Atk.Bns."+22','Magic Damage +14','Mag. Acc.+2','"Mag.Atk.Bns."+9',}},ring1="Shiva Ring",ring2="Strendu Ring",
    ...
    sets.midcast['Elemental Magic'].Resistant = {main={ name="Grioavolr", augments={'"Fast Cast"+2','Mag. Acc.+30','"Mag.Atk.Bns."+29','Magic Damage +5',}},
		sub="Clerisy Strap",ammo="Witchstone",
        head="Wicce Petasos",neck="Mizukage-no-Kubikazari",ear1="Barkarole Earring",ear2="Halasz Earring",
        body="Hagondes Coat +1",hands={ name="Merlinic Dastanas", augments={'Mag. Acc.+22 "Mag.Atk.Bns."+22','Magic Damage +14','Mag. Acc.+2','"Mag.Atk.Bns."+9',}},ring1="Stikini Ring",ring2="Stikini Ring",
        back="Taranus's Cape",waist=gear.ElementalObi,legs="Amalric Slops", feet={ name="Merlinic Crackows", augments={'Mag. Acc.+23 "Mag.Atk.Bns."+23','Magic Damage +9','MND+5','Mag. Acc.+7',}},}
    ...
    sets.idle = {main={ name="Grioavolr", augments={'"Fast Cast"+2','Mag. Acc.+30','"Mag.Atk.Bns."+29','Magic Damage +5',}},
		sub="Clerisy Strap",ammo="Impatiens",
        head="Befouled Crown",neck="Weike Torque",ear1="Barkarole Earring",ear2="Loquacious Earring",
        body={ name="Amalric Doublet", augments={'MP+60','Mag. Acc.+15','"Mag.Atk.Bns."+15',}},
		hands={ name="Amalric Gages", augments={'INT+10','Mag. Acc.+15','"Mag.Atk.Bns."+15',}},
		ring1="Vocane Ring",ring2="Paguroidea Ring",
    ...
    -- Town gear.
    sets.idle.Town = {main={ name="Grioavolr", augments={'"Fast Cast"+2','Mag. Acc.+30','"Mag.Atk.Bns."+29','Magic Damage +5',}},
		sub="Clerisy Strap",ammo="Impatiens",
    ...
    sets.magic_burst = {main={ name="Grioavolr", augments={'"Fast Cast"+2','Mag. Acc.+30','"Mag.Atk.Bns."+29','Magic Damage +5',}},
    sub="Clerisy Strap",
    head={ name="Helios Band", augments={'Evasion+20','"Occult Acumen"+10','Magic burst mdg.+10%',}},
    hands={ name="Amalric Gages", augments={'INT+10','Mag. Acc.+15','"Mag.Atk.Bns."+15',}},
	--body={ name="Amalric Doublet", augments={'MP+60','Mag. Acc.+15','"Mag.Atk.Bns."+15',}},
