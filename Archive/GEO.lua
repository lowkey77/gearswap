...
function init_gear_sets()
    ...
    sets.precast.FC = {main="",sub="",ammo="I",
        ...
        back="Swith Cape +1",waist="Witful Belt",legs="Geomancy Pants +1",feet="Chelona boots"}
    ...
    sets.midcast.FastRecast = {main="Tamaxchi",sub="Genbu Shield",
        head="Nahtirah Hat",ear1="Enchanter Earring +1",ear2="Loquacious Earring",
    ...
    sets.midcast.Geomancy = {main="Tamaxchi",range="Dunna",
		head="Azimuth Hood",ear1="Enchanter Earring +1",ear2="Loquacious Earring",
		body="Bagua Tunic +1",hands="Geomancy Mitaines +1",
        back="Lifestream Cape",legs="Bagua Pants +1",feet="Medium's Sabots"}
     
    sets.midcast.Geomancy.Indi = {main="Tamaxchi",range="Dunna",
        head="Azimuth Hood",body="Bagua Tunic +1",hands="Geomancy Mitaines +1",
        back="Lifestream Cape",legs="Bagua Pants +1",feet="Azimuth Gaiters"}
     
    sets.midcast.Cure = {main="Tamaxchi",sub="Genbu's Shield", head="Vanya Hood",
    ...
    sets.midcast['Elemental Magic'] = {main="Tamaxchi",sub="Genbu Shield",ammo="Dosis Tathlum",
        ...
        back="Lifestream Cape",waist=gear.ElementalObi,legs="Azimuth Tights",feet="Amalric Nails"}
 
    sets.midcast['Elemental Magic'].Resistant = {main="Tamaxchi",sub="Genbu Shield",ammo="Dosis Tathlum",
        head="Helios Band",neck="Eddy Necklace",ear1="Hecate's Earring",ear2="Friomisi Earring",
        body="Azimuth Coat",hands="Lurid Mitts",ring1="Icesoul Ring",ring2="Acumen Ring",
        back="Lifestream Cape",waist=gear.ElementalObi,legs="Azimuth Tights",feet="Amalric Nails"}
    ...
    sets.idle = {main="Tamaxchi",sub="Genbu's Shield",range="Dunna",
        ...
        back="Umbra Cape",waist="Goading Belt",legs="Bagua Pants +1",feet="Geomancy sandals +1"}
 
    sets.idle.PDT = {main="Tamaxchi",sub="Genbu's Shield",range="Dunna",
        head="Hagondes Hat",neck="Twilight Torque",ear1="Bloodgem Earring",ear2="Loquacious Earring",
        body="Hagondes Coat +1",hands="Hagondes cuffs",ring1="Dark Ring",ring2="Shelter Ring",
        back="Umbra Cape",waist="Goading Belt",legs="Hagondes pants +1",feet="Hagondes sabots"}
 
    -- .Pet sets are for when Luopan is present.
    sets.idle.Pet = {main="Tamaxchi",sub="Genbu's Shield",range="Dunna",
        head="Azimuth Hood1",neck="Twilight Torque",ear1="Handler's Earring +1",ear2="Ethereal Earring",
        body="Azimuth Coat",hands="Geomancy Mitaines +1",ring1="Defending Ring",ring2="Paguroidea Ring",
        back="Lifestream Cape",waist="Goading Belt",legs="Hagondes pants +1",feet="Bagua Sandals +1"}
 
    sets.idle.PDT.Pet = {main="Tamaxchi",sub="Genbu's Shield",range="Dunna",
        head="Azimuth Hoot",neck="Twilight Torque",ear1="Handler's Earring +1",ear2="Ethereal Earring",
        body="Azimuth Coat",hands="Yaoyotl Gloves",ring1="Defending Ring",ring2="Paguroidea Ring",
        back="Lifestream Cape",waist="Goading Belt",legs="Hagondes pants +1",feet="Azimuth Gaiters"}
    ...
    sets.idle.Town = {main="Tamaxchi",sub="Genbu's Shield",range="Dunna",
    ...
    sets.idle.Weak = {main="Bolelabunga",sub="Genbu's Shield",range="Nepote Bell",
        ...
        body="Heka's Kalasiris",hands="Serpentes Cuffs",ring1="Sheltered Ring",ring2="Paguroidea Ring",
        back="Umbra Cape",waist="Goading Belt",legs="Hagondes pants +1",feet="Geomancy Sandals +1"}
    ...
    -- Normal melee group
    sets.engaged = {main="Tamaxchi",range="Dunna",
